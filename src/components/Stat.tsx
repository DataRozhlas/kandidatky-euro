import { User, UserCheck, CalendarClock } from "lucide-react"
...
export default function Stat({ title, number, subtitle, icon }: { title: string, number: string, subtitle: string, icon: "user" | "user-check" | "female" | "clock" }) {
    return (
        <Card className="min-w-32 w-half-minus-gap sm:w-1/3">
